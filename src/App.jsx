        ...
        <Routes>
            ...
            <Route path="/home" element={<HomeView />}>
              <Route path="users" element={<UsersView />}>
                ...
                <Route index path="active-members" element={<ActiveUsersList />} />
                <Route index path="waitlisted" element={<WaitlistedUsersList />} />
              </Route>
              <Route path="cohorts" element={<span>Cohorts</span>} />
              <Route path="events" element={<EventsView />}>
                <Route index path="upcoming" element={<UpcomingEvents />} />
                <Route index path="past" element={<span>Past Events</span>} />
              </Route>
